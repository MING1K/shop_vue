    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :skuImageList="skuInfo.skuImageList" :imgNum="imgNum" />
          <!-- 小图列表 -->
          <ImageList
            @changeImgNum="changeImgNum"
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr, index) in spuSaleAttrList" :key="index">
                ...
                <dd
                  v-for="(cho, index) in attr.spuSaleAttrValueList"
                  :key="cho.id"
                  :class="{ active: cho.isChecked === '1' }"
                  @click="changeSaleAttrActive(cho, attr.spuSaleAttrValueList)"
                >
                  {{ cho.saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
              ...
              <div class="add">
                <a @click="handleAddShopCar">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    changeSaleAttrActive(saleAttrValue, arr) {
